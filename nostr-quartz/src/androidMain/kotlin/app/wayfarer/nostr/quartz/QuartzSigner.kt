...
/**
 * Signers Quartz can build on its own.
 *
 * [Credential.ExternalSigner] is deliberately absent: NIP-55 signing means
 * launching an Android activity, which is not this module's business. The app
 * layer wraps this factory to add that case.
 */
        ...
        when (credential) {
            ...
            is Credential.ExternalSigner ->
                throw IllegalArgumentException(
                    "NIP-55 external signing is provided by the app layer, not the Quartz backend",
                )
        }
    }
